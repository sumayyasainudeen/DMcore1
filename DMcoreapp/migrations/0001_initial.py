# Generated by Django 4.1.4 on 2023-07-22 11:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('smo_start_date', models.DateField(blank=True, null=True)),
                ('smo_end_date', models.DateField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date', models.DateField(default=datetime.date(2023, 7, 22))),
                ('name', models.CharField(blank=True, default='', max_length=255, null=True)),
                ('email_id', models.CharField(blank=True, default='', max_length=255, null=True)),
                ('ph_no', models.CharField(blank=True, default='', max_length=255, null=True)),
                ('location', models.CharField(blank=True, default='', max_length=255, null=True)),
